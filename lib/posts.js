import { kilimanjaroImage } from "./site"
...
export const posts = [
    {
        ...
        body: [
            ...
            { type: "p", text: "It requires educators, healthcare professionals, businesses, community leaders, volunteers, donors, and everyday Africans who believe that education should never be interrupted by a lack of access to basic menstrual care." },
    ...
    },
    {
        ...
        author: "Flow Forward Africa",
        category: "The Climb",
        image: kilimanjaroImage(1200, 750),
        body: [
            ...
            { type: "quote", text: "Every metre we climb represents another step towards ensuring that girls across Africa have access to menstrual products, education, and the dignity they deserve." },
            ...
            { type: "p", text: "Rather than asking people to donate simply, we wanted to create a challenge that reflected the commitment required to create meaningful change. The Kilimanjaro climb has become a symbol of resilience, determination, and collective action. Corporations are pledging sponsorships based on every metre climbed, while individuals are joining our BackaBuddy campaign to help expand the impact even further." },
            { type: "p", text: "Together, these contributions will directly support the distribution of menstrual products, community outreach programmes, educational workshops, and partnerships that empower girls where support is needed most. This journey has already shown us that lasting impact is never created alone." },
            { type: "p", text: "It is built through organisations that open their doors, communities that share their lived experiences, volunteers who generously give their time, and businesses that choose to invest in something greater than themselves." },
